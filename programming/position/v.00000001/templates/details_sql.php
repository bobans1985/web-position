 ...
 $sql1 = "select 
		...
		BNK.cBNKpurp     purpose
			  from POT, 
			       ...
			       FOG, 
			       DVR 
				  where POT.dPOTdebarkat=to_date(to_char(sysdate,'DD.MM.YYYY'),'DD.MM.YYYY') and 
...
$sql2 = "select 
			  ...
			  from TRN, 
				  ...
				  where  
				        /*TRN{*/ 
					 dTRNtran between to_Date(sysdate,'DD.MM.RRRR') 
	                                and to_Date(sysdate||' 23:59:59','DD.MM.RRRR HH24:MI:SS') and 
...
$sql3 = "select 
		...
		NVL(NVL(FOG.cFOGshortname,FOG.cFOGname),PS_PP_Prepayment.corr_bic) corr_bank_name,
	        PS_PP_Prepayment.CLIENT_ACC,PS_PP_Prepayment.CORR_ACC,PS_PP_Prepayment.DOC_NUM,
	        to_Char(PS_PP_Prepayment.AMOUNT,'fm999g999g999g999g990d00') amount
				  ...
				  where FOG.cFOGmfo8(+)=PS_PP_Prepayment.corr_bic and
				        ...
				        portion_date=to_date(to_char(sysdate,'DD.MM.YYYY'),'DD.MM.YYYY') and
				        portion_num=".$num."
		  ...
		  from TRN, 
		       ...
		       CUS 
         		  where  
			        /*TRN{*/ 
			        cTRNemptytran='1' and 
			        NVL(dTRNval,dTRNcreate)<=to_Date(to_Char(sysdate,'DD.MM.RRRR'),'DD.MM.RRRR') and 
...
$sql5= "select  
			  ...
			  from DP_Doc, 
			       ACC, 
			       CUS 
				  where DP_Doc.dcreate<=to_date(to_Char(sysdate,'DD.MM.RRRR'),'DD.MM.RRRR') and 
				        DP_Doc.ccur='RUR' and 
			         ...
			         iTRNanum) not in (select PS_PP_ED101.trn_num, 
					        ...
					        (iTRNnum, 
					         iTRNanum) in (select D2P.iD2Ptrnnum, 
		                                     ...
		                                     from POT, 
		                                          D2P 
		                                     where POT.dPOTdebarkat=to_Date(to_Char(sysdate,'DD.MM.RRRR'),'DD.MM.RRRR') and 
...
$sql8= "select       TRN.iTRNdocnum doc_num, 
                     to_Char(TRN.mTRNsum,'fm999g999g999g999g990d00')   amount, 
		       NVL(CUS.cCUSname_sh,CUS.cCUSname) client_name, 
		       ACC.cACCacc                       client_acc, 
		       TRN.cTRNowna   corr_name, 
...
$sql9= "select IPOTPORTION,
    ...
    (select    POT.iPOTid,
        ...
        where 
             dPOTdebarkat=to_date(to_Char(sysdate,'DD.MM.RRRR'),'DD.MM.RRRR') and
