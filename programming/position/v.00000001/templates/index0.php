      ...
      <table class="base_txt" width="100%" border="0" cellspacing="3" cellpadding="3">
        <tr>
          ...
          <td width="412" class="Txt11" align="left" valign="top"><table width="100%" border="0" cellpadding="2" cellspacing="2">
              ...
              <tr>
                <td bgcolor="#B4DAE7" class="Txt11" >Время: </td>
                <td bgcolor="#B4DAE7" class="Txt11" ><?php echo date("d.m.Y H:i:s"); ?>&nbsp;</td>
              </tr>
          </table></td>
        </tr>
      </table>
        ...
        <tr>
          <td align="left" valign="top" bgcolor="#E0F5F1"><table class="base_txt" width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td width="150" bgcolor="#BBEAE0" class="Txt11" ><a href="details.php?id=1"><?PHP echo $results['S_1'][0];?>&nbsp</a></td>
              </tr>
              <tr>
                <td bgcolor="#BBEAE0" class="Txt11" >В том числе по рейсам: </td>
                <td bgcolor="#BBEAE0" class="Txt11" ><a href="details.php?id=9"><?PHP echo $results['S_2'][0];?>&nbsp</a></td>
              </tr>
              <tr>
                <td bgcolor="#BBEAE0" class="Txt11" >Предварительные поступления: </td>
                <td bgcolor="#BBEAE0" class="Txt11" ><a href="details.php?id=3&num=<?PHP if (!empty($results['S_4'][0])) echo substr($results['S_4'][0],5,1); else echo "1" ?>" ><?PHP echo $results['S_3'][0];?>&nbsp</a></td>
              </tr>
              <tr>
          ...
          <td align="left" valign="top" bgcolor="#E0F5F1"><table class="base_txt" width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td width="150" bgcolor="#BBEAE0" class="Txt11" ><a href="details.php?id=2"><?PHP echo $results['S_5'][0];?>&nbsp</a></td>
              </tr>
              <tr>
              ...
              <tr>
                <td bgcolor="#BBEAE0" class="Txt11" >Платежи к отпраке: </td>
                <td bgcolor="#BBEAE0" class="Txt11" ><a href="details.php?id=4"><?PHP echo $results['S_8'][0];?>&nbsp</a></td>
              </tr>
              <tr>
                <td bgcolor="#BBEAE0" class="Txt11" >Выгруженные платежи: </td>
                <td bgcolor="#BBEAE0" class="Txt11" ><a href="details.php?id=6"><?PHP echo $results['S_9'][0];?>&nbsp</a></td>
              </tr>
              <tr>
                <td bgcolor="#BBEAE0" class="Txt11" >В реестре для МЦИ: </td>
                <td bgcolor="#BBEAE0" class="Txt11" ><a href="details.php?id=7"><?PHP echo $results['S_10'][0];?>&nbsp</a></td>
              </tr>
              <tr>
                <td bgcolor="#BBEAE0" class="Txt11" >Принятые МЦИ платежи</td>
                <td bgcolor="#BBEAE0" class="Txt11" ><a href="details.php?id=8"><?PHP echo $results['S_11'][0];?>&nbsp</a></td>
              </tr>
              <tr>
                <td bgcolor="#BBEAE0" class="Txt11" >Отложенные платежи</td>
                <td bgcolor="#BBEAE0" class="Txt11" ><a href="details.php?id=5"><?PHP echo $results['S_12'][0];?>&nbsp</a></td>
              </tr>
          </table></td>
        </tr>
      </table>
